...
Đã tìm hiểu và học được những gì
Đã áp dụng vào dự án demo như thế nào
Còn thiếu sót gì, cần cải thiện và học thêm những gì

Publish , để mà có
REPR

Nếu xcux thì coi lại, gạch cũng vậy. Tap Response
Chaeck lại

Event binding ()
Attribute [ư]

Mình chỉ đan gdungf cái người ta đang có, để mà thành thục hơn

các việc cacle thì nên để bên trong cái loop : ThrowIfCancellationRequested

Channle worker

Nếu dùng Notiffication gửi cho nhiều kênh, thì dùng Enumerable để có gì for từng cái kênh mà mình implement thì tới lúc dùng for để tìm đúng các channle mà tôi dùng.

Nếu người dùng mà muoons1 channle, 1 cái, nhiều cái, 2 cái , không cái nào. > Nên hiểu đê có thể thiết kế có thể sửa cde ít nhất, để nghĩ tới những trường hợp phức tạp hơn.
=>User cần thay đôiủ
Hệ thống tốt, nghĩ hệ thống sẽ cso thể handle được những việc nào sao này. Nếu muốn bự hơn , phức tạp hơn thì mình vẫn có thể sửa code ít nhất được

Luôn nghi ngờ static. gọi với handel gọi DB mà có static sẽ có gì đó, nên nghi ngờ tụi nó

Trình độ = tò mò. TÌm hiểu nhiều thì biết nhiều hơn người ta. EZ

Dùng mail gun với FLuent Mail. FMTF, Mail gun, ingrit, fmtp for dev, gửi thoải mái. nằm tỏng local, để test, khig public để test qua lại.
Dùng channle nhiều cái thì sao?
DB Agritation
COi lại hết các công nghệ, thư viện basic mà đang làm để ngày mai coi dự án thực tế.
Nghĩ lại theo thực tế, dùng mail gun

call với Chị Linh để mà xme dự án thật.
...
https://github.com/LuckyPennySoftware/MediatR/wiki

https://we.tl/t-NhkaAzeKszKFwPAu
zzz
